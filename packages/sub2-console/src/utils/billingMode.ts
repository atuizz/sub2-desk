...
export function getBillingModeLabel(mode: string | null | undefined): string {
  switch (mode) {
    case BILLING_MODE_PER_REQUEST: return '按次计费'
    case BILLING_MODE_IMAGE: return '生图'
    case BILLING_MODE_VIDEO: return '视频'
