...
export interface SubscriptionPlan {
  ...
  /** User checkout DTO: the public/user API returns an array. */
  features: string[]
  for_sale: boolean
  sort_order: number
}

/** Admin plan endpoints expose newline-separated features, unlike checkout. */
export interface AdminSubscriptionPlan extends Omit<SubscriptionPlan, 'features'> {
  features: string
  product_name?: string
}

export type CreateAdminPlanRequest = Pick<AdminSubscriptionPlan,
...
export type UpdateAdminPlanRequest = Partial<CreateAdminPlanRequest>
