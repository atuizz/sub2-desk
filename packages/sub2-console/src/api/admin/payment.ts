...
export const adminPaymentAPI = {
  ...
  createPlan(data: CreateAdminPlanRequest) {
    return apiClient.post<AdminSubscriptionPlan>('/admin/payment/plans', data)
  },

  /** Update a subscription plan */
  updatePlan(id: number, data: UpdateAdminPlanRequest) {
    return apiClient.put<AdminSubscriptionPlan>(`/admin/payment/plans/${id}`, data)
  },
